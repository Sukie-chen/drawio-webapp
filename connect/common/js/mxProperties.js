...
var mxLanguageMap = {
	// 'i18n': '',
	//  'id' : 'Bahasa Indonesia', 'ms' : 'Bahasa Melayu', 'bs' : 'Bosanski', 'ca' : 'Català', 'cs' : 'Čeština', 'da' : 'Dansk', 'de' : 'Deutsch', 'et' : 'Eesti', 
	'en' : 'English', 
	// 'es' : 'Español', 
	...
	// 	'ar' : 'العربية', 'th' : 'ไทย', 'ko' : '한국어', 'ja' : '日本語', 
		'zh' : '简体中文'
		// ,  'zh-tw' : '繁體中文'
	};

...
(function()
{
    ...
    EditorUi.initTheme = function()
    {
    	if (uiTheme == 'atlas')
    	{
    		...
    		EditorUi.prototype.menubarHeight = 30; //41;
    		EditorUi.prototype.toolbarHeight = 30; //38;
    	}
...
//		}
	...
	EditorUi.prototype.isRevisionHistoryEnabled = function()
	{
		...
		//  &&
		// 		(
		// 			(file.constructor == window.DriveFile && file.isEditable())
		// 			//  ||file.constructor == window.DropboxFile
		// 		);
	};
